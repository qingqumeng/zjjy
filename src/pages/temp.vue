<template>
  <div>
    ...
    <group title="使用icon代替title">
      <x-input title="必须输入2333" :is-type="be2333" placeholder="提示">
        <img slot="label" style="padding-right:10px;display:block;" src="static/img/bj.jpg" width="24" height="24">
      </x-input>
    </group>
    ...
    <group title="验证码">
      <x-input title="验证码">
        <img slot="right-full-height" src="static/img/bj.jpg">
      </x-input>
