<template>
  <div>
    <group title="single column" label-width="5em">
      ...
      <popup-picker popup-title="('please select')" :title="title1" :data="list1" v-model="value1_1" @on-show="onShow" @on-hide="onHide" @on-change="onChange" placeholder="('please select')">
